...
**[Website and live 3D model](https://tamnisan.github.io/luma/)** · **[Build guide](https://tamnisan.github.io/luma/build-guide.html)** · **[Download ZIP](https://github.com/tamnisan/luma/archive/refs/heads/main.zip)**
...
The **[build guide](build-guide.html)** ([online](https://tamnisan.github.io/luma/build-guide.html)) covers building a prototype:

- the full parts list with specifications, each checked against the space the CAD reserves: Arduino Uno, TCS34725 colour sensor, white LEDs, micro stepper, 2S battery, switches, and the printed, stainless-steel and EPDM parts
- labelled layout diagrams showing where every component goes (the Arduino sits upright in the upper-left corner of the dry electronics compartment)
- eight assembly steps, each with a picture and a link that highlights those parts in the 3D viewer
- a suggested Arduino wiring table, power path, first power-up tests and the service routine
...
├── build-guide.html              Parts list, layout diagrams, assembly steps and wiring (generated by src/Guide.js)
...
├── docs/                         README and build-guide images, social preview card
├── builds/
...
| `src/Guide.js` | Website build guide: parts tables, layout diagrams and assembly steps from `BOM.csv` |
